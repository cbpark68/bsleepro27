package com.spring.member.common;
...
public class LoggingAdvice {
	...
	/*@Before("execution(* com.myspring.pro27.member.service.*.*(..)) or "
	  ...
	  @Before("execution(* com.spring.member.service.*.*(..)) or " +
	  "execution(* com.spring.member.dao.*.*(..))")
	...
	/*@After("execution(* com.myspring.pro27.member.service.*.*(..)) or "
	  ...
	  @After("execution(* com.spring.member.service.*.*(..)) or " +
	  "execution(* com.spring.member.dao.*.*(..))")
	...
	/*@Around("execution(* com.myspring.pro27.member.service.*.*(..)) or "
	  ...
	  @Around("execution(* com.spring.member.service.*.*(..)) or " +
	  "execution(* com.spring.member.dao.*.*(..))")
